package com.erenalparslan.survivorbird;
...
// TODO: 2/27/2023 bird selection 
// TODO: 2/27/2023 difficulty level
// TODO: 2/27/2023 design improvement 
    ...
    public void render () {
        ...
        if (gameState ==1) {
            ...
            if (enemyX[scoredEnemy] < Gdx.graphics.getWidth() / 2 - bird.getHeight() / 2) {
                score++;                                            //if the enemy is behind the bird
            ...
            for (int i = 0; i < numberOfEnemies; i++) {
                ...
                if (enemyX[i] < Gdx.graphics.getWidth()/15 ) {
                    ...
                    enemyOffSet[i] = (random.nextFloat() - 0.5f) * (Gdx.graphics.getHeight() - 200);
                    enemyOffSet2[i] = (random.nextFloat() - 0.5f) * (Gdx.graphics.getHeight() - 200);       //Random -axis
                    enemyOffSet3[i] = (random.nextFloat() - 0.5f) * (Gdx.graphics.getHeight() - 200);
            ...
            if (birdY > 0) {
                velocity = velocity + gravity;          //bird fly
                birdY = birdY - velocity;
            } else {
                gameState = 2;              //bird's fall
            }
